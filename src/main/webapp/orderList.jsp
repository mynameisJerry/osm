...
<script type="text/javascript">
	function showOrder(orderId){
		location.href="${pageContext.request.contextPath}/order/getorderdetail?oid="+orderId;
	}
	function changeStatus(orderId){
		if(confirm("确定要收货吗?")){
			location.href="${pageContext.request.contextPath}/order/changestatus?oid="+orderId+"&num="+Math.random();
		}
	}
</script>
</head>
