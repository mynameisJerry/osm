		...
		<div class="page_main">
			<script type="text/javascript">
                $("#logout").click(function(){
                    $(".dv_content").attr("src","${pageContext.request.contextPath}/admin/logout");
                })
				$("#showUser").click(function(){
					$(".dv_content").attr("src","${pageContext.request.contextPath}/admin/getuserlist");
				})
                $("#invalid").click(function(){
                    $(".dv_content").attr("src","${pageContext.request.contextPath}/admin/getinvaliduserlist");
                })
				$("#showGoodsType").click(function(){
					$(".dv_content").attr("src","${pageContext.request.contextPath}/goods/getgoodstype");
				})
				...
				$("#showGoods").click(function(){
					$(".dv_content").attr("src","${pageContext.request.contextPath}/goods/getgoodslist");
				})
				$("#addGoods").click(function(){
					$(".dv_content").attr("src","${pageContext.request.contextPath}/admin/addGoods.jsp");
				})
				$("#showOrder").click(function(){
					$(".dv_content").attr("src","${pageContext.request.contextPath}/order/getallorder");
				})
			</script>
