...
<title>商品列表</title>
	...
	<script type="text/javascript">
        ...
        function deleteGoods(id){
            ...
            if(res==true){
                window.location.href="${pageContext.request.contextPath }/goods/deleteGoods?id="+id;
            }
        }
        ...
        $(function(){
            ...
            $("#search").click(function(){
                ...
                //使用ajax 进行异步交互
                $.ajax({
                    url:"${pageContext.request.contextPath}/goods/searchgoodslist?name="+name+"&pubdate="+pubdate,
                    method:"post",
									...
									<div class="modal fade" tabindex="-1" role="dialog" id="myModal${goods.id}">
										<div class="modal-dialog" role="document">
											<div class="modal-content">
												...
												<form action="${pageContext.request.contextPath }/goods/updategoods" method="post" enctype="multipart/form-data" class="form-horizontal" style="padding:10px">
