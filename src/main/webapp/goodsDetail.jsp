			  ...
			  <div class="panel-body">
			    ...
			    <div style="margin-left: 10px;">
				   ...
				   <p>市场价格:&nbsp;&nbsp;&nbsp;<span class="text-danger" style="font-size: 15px;">${goods.price}</span>&nbsp;&nbsp;&nbsp;<span class="glyphicon glyphicon-yen"></span></p> 
				    ...
				    <a href="${pageContext.request.contextPath}/order/justbuy?goodsId=${goods.id}&number=1" class="btn btn-danger">直接购买&nbsp;&nbsp;&nbsp;<span class="glyphicon glyphicon-shopping-cart"></span></a>&nbsp;&nbsp;&nbsp;
