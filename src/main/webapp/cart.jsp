...
<script type="text/javascript">
	function pNum(pid,p,no){
		$.ajax({
			url:"${pageContext.request.contextPath}/cart/addcartajax?goodsId="+pid+"&number=1&n="+Math.random(),
			method:"get",
			success:function(){
				location.href = "${pageContext.request.contextPath}/cart/getcart?num="+Math.random();
			},
			error:function(){
				alert("服务器异常");
			}
	...
	function mNum(pid,p,no){
		...
		$.ajax({
			url:"${pageContext.request.contextPath}/cart/addcartajax?goodsId="+pid+"&number="+num+"&n="+Math.random(),
			method:"get",
			success:function(){
				location.href = "${pageContext.request.contextPath}/cart/getcart?num="+Math.random();
			},
	...
	function deleteCart(pid){
		if(confirm("确认要删除吗")){
			$.ajax({
				url:"${pageContext.request.contextPath}/cart/addcartajax?goodsId="+pid+"&number=0&n="+Math.random(),
				method:"get",
				success:function(){
					location.href = "${pageContext.request.contextPath}/cart/getcart?num="+Math.random();
				},
	...
	function clearCart(){
		if(confirm("确定要清空吗")){
			$.ajax({
				url:"${pageContext.request.contextPath}/cart/clearcartajax?n="+Math.random(),
				method:"get",
				success:function(){
					location.href = "${pageContext.request.contextPath}/cart/getcart?num="+Math.random();
				},
	...
	<div class="row">
		<div class="pull-right" style="margin-right: 40px;">
	            ...
	            <div>
	            	...
	            	&nbsp;&nbsp;
	            	<a href="${pageContext.request.contextPath}/order/account" class="btn  btn-danger btn-lg">结账</a>
